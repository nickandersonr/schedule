...
----- | -------- | --------------------------------                         | ------------------------------------                  | ------------------------------------     | ---------------------------------------   |
 **9:00am Warm-Up** | [Welcome to GA][1-1A] (Both) | [CSS selector basics (Zeb)][1-2A] | Work through Lab Issues | [Kyrel 1 (Zeb)][1-4A] | [Kyrel 2 (Zeb)][1-5A]
 **9:30am Module 1** | [Orientation][1-1B] (Both) | [Box model and positioning (Zeb)][1-2B] | [JS Data types, variables, and arrays (Zeb)][1-3B] |  [Functions and scope (Zeb)][1-4B] | [Second Pass](https://github.com/den-wdi-2/week1_secondPass) and [Questions in a Line (Zeb)][1-5B]
...
**3:00pm Module 4** | [WDI Diagnostic][1-1E] and GH Issue Session (Nick) | [Lab: Design and CSS Challenge (Nick)][1-2E] | [Chrome dev tools (Nick)][1-3E] | [Lab: DOM manipulation LoTR (Nick)][1-4E] | [Week 1 Assessment: Pixel Perfect Website (Nick)][1-5E]   
**Training** | [Lab: Command line][1-1F] (Zeb) | Finish Design/CSS Lab | [Lab: Build a website (Nick)][1-3F] | Finish LOTR Lab | Continue Instagram Recreation
